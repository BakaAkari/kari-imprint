...
现已退化为本模块的兼容别名 shim。所有新代码请直接 ``from kari_core.core.config_loader import ...``。
"""
...
PROJECT_ROOT_FOR_INFO = Path(
    os.environ.get("KARI_IMPRINT_ROOT", str(PROJECT_ROOT.parent.parent))
).resolve()
PROJECT_INFO_PATH = PROJECT_ROOT_FOR_INFO / "pyproject.toml"
