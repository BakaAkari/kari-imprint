...
from kari_core.core.config_loader import FONTS_DIR as fonts_dir
from kari_core.processor.core import Direction, ImageProcessor, PipelineContext, _parse_color, register
...
class ImageLoader(Generator):
    def process(self, ctx: PipelineContext):
        ...
        from kari_core.core.image_io import load_image_safely
