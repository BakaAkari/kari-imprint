...
from kari_core.core.util import _parse_exiftool_block, get_exif_batch
...
def test_get_exif_batch_subprocess_failure_falls_back(tmp_path):
    ...
    with patch("kari_core.core.util.subprocess.check_output", side_effect=OSError("boom")):
...
def test_get_exif_batch_calls_subprocess_once(tmp_path):
    ...
    import kari_core.core.util as util_mod
