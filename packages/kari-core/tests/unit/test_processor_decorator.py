...
import kari_core.processor  # noqa: F401  # 触发自动注册副作用
from kari_core.processor import core as proc_core
...
from kari_core.processor.filters import (
    BlurFilter,
    FilterProcessor,
    ResizeFilter,
)
from kari_core.processor.generators import Generator
from kari_core.processor.mergers import Merger
